...
CREATE TABLE `accounts` (
  ...
  `is_logical` tinyint(1) NOT NULL DEFAULT 0,
...
INSERT INTO `accounts` (`id`, `master_account_id`, `parent_account_id`, `code`, `account_name`, `description`, `is_logical`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `assets` (
  ...
  `date` date NOT NULL DEFAULT '2025-03-11',
  `name` varchar(255) NOT NULL,
  `image` text DEFAULT NULL,
  `description` text DEFAULT NULL,
  `purchase_price` decimal(15,2) NOT NULL,
  `residu_price` decimal(15,2) NOT NULL,
  `useful_life` decimal(5,2) DEFAULT NULL,
  `is_appreciating` tinyint(1) NOT NULL DEFAULT 0,
  `appreciation_rate` decimal(5,2) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `master_accounts` (`id`, `code`, `type`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `po_invoice_transactions`
--

CREATE TABLE `po_invoice_transactions` (
  `id` char(36) NOT NULL,
  `po_invoice_id` char(36) DEFAULT NULL,
...
--
-- Table structure for table `po_payment_transactions`
--

CREATE TABLE `po_payment_transactions` (
  `id` char(36) NOT NULL,
  `po_payment_id` char(36) DEFAULT NULL,
  `transaction_id` char(36) DEFAULT NULL,
  `description` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Table structure for table `ro_invoice_transactions`
--

CREATE TABLE `ro_invoice_transactions` (
  `id` char(36) NOT NULL,
  `ro_invoice_id` char(36) DEFAULT NULL,
  `transaction_id` char(36) DEFAULT NULL,
  `description` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Table structure for table `ro_payment_transactions`
--

CREATE TABLE `ro_payment_transactions` (
  `id` char(36) NOT NULL,
  `ro_payment_id` char(36) DEFAULT NULL,
  `transaction_id` char(36) DEFAULT NULL,
  `description` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Table structure for table `tp_invoice_transactions`
--

CREATE TABLE `tp_invoice_transactions` (
  `id` char(36) NOT NULL,
  `tp_invoice_id` char(36) DEFAULT NULL,
  `transaction_id` char(36) DEFAULT NULL,
  `description` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Table structure for table `tp_payment_transactions`
--

CREATE TABLE `tp_payment_transactions` (
  `id` char(36) NOT NULL,
  `tp_payment_id` char(36) DEFAULT NULL,
  `transaction_id` char(36) DEFAULT NULL,
  `description` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `transactions` (
  `id` char(36) NOT NULL,
  `transaction_period_id` char(36) NOT NULL,
  `code` varchar(255) NOT NULL,
  `date` date NOT NULL DEFAULT '2025-03-11',
...
ALTER TABLE `accounts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `accounts_master_account_id_foreign` (`master_account_id`);
...
--
-- Indexes for table `po_invoice_transactions`
--
ALTER TABLE `po_invoice_transactions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `po_invoice_transactions_transaction_id_foreign` (`transaction_id`);

--
-- Indexes for table `po_payment_transactions`
--
ALTER TABLE `po_payment_transactions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `po_payment_transactions_transaction_id_foreign` (`transaction_id`);

--
-- Indexes for table `ro_invoice_transactions`
--
ALTER TABLE `ro_invoice_transactions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ro_invoice_transactions_transaction_id_foreign` (`transaction_id`);

--
-- Indexes for table `ro_payment_transactions`
--
ALTER TABLE `ro_payment_transactions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ro_payment_transactions_transaction_id_foreign` (`transaction_id`);

--
-- Indexes for table `tp_invoice_transactions`
--
ALTER TABLE `tp_invoice_transactions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tp_invoice_transactions_transaction_id_foreign` (`transaction_id`);

--
-- Indexes for table `tp_payment_transactions`
--
ALTER TABLE `tp_payment_transactions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tp_payment_transactions_transaction_id_foreign` (`transaction_id`);
...
ALTER TABLE `transactions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `transactions_transaction_period_id_foreign` (`transaction_period_id`);
...
--
ALTER TABLE `accounts`
  ADD CONSTRAINT `accounts_master_account_id_foreign` FOREIGN KEY (`master_account_id`) REFERENCES `master_accounts` (`id`);

--
-- Constraints for table `assets`
--
ALTER TABLE `assets`
  ADD CONSTRAINT `assets_account_id_foreign` FOREIGN KEY (`account_id`) REFERENCES `accounts` (`id`) ON DELETE SET NULL;
...
--
-- Constraints for table `po_invoice_transactions`
--
ALTER TABLE `po_invoice_transactions`
  ADD CONSTRAINT `po_invoice_transactions_transaction_id_foreign` FOREIGN KEY (`transaction_id`) REFERENCES `transactions` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `po_payment_transactions`
--
ALTER TABLE `po_payment_transactions`
  ADD CONSTRAINT `po_payment_transactions_transaction_id_foreign` FOREIGN KEY (`transaction_id`) REFERENCES `transactions` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `ro_invoice_transactions`
--
ALTER TABLE `ro_invoice_transactions`
  ADD CONSTRAINT `ro_invoice_transactions_transaction_id_foreign` FOREIGN KEY (`transaction_id`) REFERENCES `transactions` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `ro_payment_transactions`
--
ALTER TABLE `ro_payment_transactions`
  ADD CONSTRAINT `ro_payment_transactions_transaction_id_foreign` FOREIGN KEY (`transaction_id`) REFERENCES `transactions` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `tp_invoice_transactions`
--
ALTER TABLE `tp_invoice_transactions`
  ADD CONSTRAINT `tp_invoice_transactions_transaction_id_foreign` FOREIGN KEY (`transaction_id`) REFERENCES `transactions` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `tp_payment_transactions`
--
ALTER TABLE `tp_payment_transactions`
  ADD CONSTRAINT `tp_payment_transactions_transaction_id_foreign` FOREIGN KEY (`transaction_id`) REFERENCES `transactions` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `transactions`
--
ALTER TABLE `transactions`
  ADD CONSTRAINT `transactions_transaction_period_id_foreign` FOREIGN KEY (`transaction_period_id`) REFERENCES `transaction_periods` (`id`);

--
-- Constraints for table `transaction_details`
--
ALTER TABLE `transaction_details`
  ADD CONSTRAINT `transaction_details_account_id_foreign` FOREIGN KEY (`account_id`) REFERENCES `accounts` (`id`),
