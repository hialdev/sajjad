...
@section('content')
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Pemrosesan Permintaan Client</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a class="text-muted text-decoration-none" href="{{ route('home') }}">Dashboard</a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">Semua Proses Permintaan</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
    ...
    <div class="mb-3 d-flex align-items-center gap-2 justify-content-between">
        <h1>Pemrosesan Permintaan Client</h1>
        <div style="aspect-ratio:1/1; width:3em; height:3em"
            ...
            {{ count($processes) }}</div>
        <a href="{{ route('request-process.add') }}" class="btn btn-primary btn-al-primary">Tambah</a>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('request-process.index') }}" method="GET">
                ...
                <table class="table border text-nowrap mb-0 align-middle">
                    <thead class="text-dark fs-4">
                        <tr>
                            ...
                            <th>
                                <h6 class="fs-3 fw-semibold mb-0">Transportasi</h6>
                            </th>
                            <th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div>
                                        ...
                                        <h6 class="fw-semibold text-primary mb-1" style="">{{ $process->requestOrder->code }}</h6>
                                    </div>
                                    <div>
                                        <div class="fw-normal fs-1 text-muted" style="white-space:normal;">Referensi
                                            Permintaan (PO)</div>
                                        <h6 class="fw-semibold text-secondary mb-1" style="">
                                            {{ $process->requestOrder->no_refrence }}</h6>
                                    </div>
                                </td>
                                <td>
                                    @if ( $process->transport )
                                    <a href="{{route('logistic.setting', $process->transport->logistic->id)}}" target="_blank" class="border border-primary p-1 px-2 rounded-2 d-flex align-items-center fs-2 mb-1 gap-2">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body pt-0">
                                                    <div class="p-3 rounded-3 border border-dashed mb-2 border-secondary">
                                                        ...
                                                        <div>
                                                            <div class="fs-3" style="white-space: normal">{{$process->pickup->address.', '.$process->pickup->city.'. '.$process->pickup->postal_code}}</div>
                                                        </div>
                                                    </div>
                                                    <div class="p-3 rounded-3 border border-dashed border-primary">
                                                        ...
                                                        <div>
                                                            ...
                                                            {{
                                                                ...
                                                                ? $process->delivery->address.', '.$process->delivery->city.'. '.$process->delivery->postal_code 
                                    ...
                                    @else
                                    <div>Tidak mengurus transportasi</div>
                                    @endif
                                </td>
                                <td>
                                    <button type="button"
                                        class="dropdown-item fs-2 text-center d-inline-flex p-2 px-3 align-items-center gap-2 bg-secondary text-white rounded-3"
                                        data-bs-toggle="modal" data-bs-target="#produkModal-{{$process->id}}"><i
                                            class="fs-4 ti ti-package"></i> {{ count($process->products) }} Produk</button>

                                    <!-- List Product modal -->
                                    <div class="modal fade " id="produkModal-{{$process->id}}" tabindex="-1"
                                        aria-labelledby="vertical-center-modal" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <div class="modal-header d-flex align-items-center">
                                                ...
                                                <div class="modal-body pt-0">
                                                    ...
                                                    @forelse ($process->products as $processProduct)
                                                        @php
                                                            $priceSale = $processProduct->price_buy ?? 0; // Harga jual (diambil dari cart)
                                                            $subtotal = $priceSale * $processProduct->qty; // Hitung subtotal awal
                                                        @endphp
                                                        <div class="border border-1 border-dashed border-primary {{$loop->index+1 == count($process->products) ? '' : 'mb-2'}} p-3 rounded-3">
                                                            <div
                                                                class="d-flex align-items-center gap-2 mb-2 {{ $loop->index == 0 ? '' : 'mt-3' }}">
                                                                <img src="{{ $processProduct?->product?->image ? '/storage/' . $processProduct?->product?->image : 'https://placehold.co/300?text=' . $processProduct?->product?->name }}"
                                                                    alt="Image Product {{ $processProduct?->product?->name }} in Cart" class="d-block rounded-2"
                                                                    style="width: 5em; height:5em; object-fit:cover">
                                                                <div>
                                                                    <div class="text-decoration-none text-dark fs-3 fw-semibold">
                                                                        {{ $processProduct?->product?->name }}</div>
                                                                    <div class="text-muted fs-2 mb-2">
                                                                        {{ $processProduct?->product?->description ?? 'tidak ada deskripsi' }}</div>
                                                                </div>
                                                                <div
                                                            ...
                                                            <div class="d-flex align-items-end gap-2">
                                                                <div>
                                                                    <label for="qty" class="text-muted fs-1">Memproses Sebanyak
                                                                        ({{ $processProduct?->product?->unit->code }})</label>
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <div>{{ formatRupiah($processProduct->price_buy) }}</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                   @empty
                                                    ...
                                                    <div class="pt-3 mt-3 border-top border-2">
                                                        <div class="d-flex align-items-center gap-2 justify-content-between">
                                                            ...
                                                            <div class="fs-4 fw-bold">{{ formatRupiah($process->total_price) }}</div>
                                                            @else
                                                            <div class="fs-4 fw-bold">Lengkapi Data Dahulu <a href="{{ route('request-process.setting', $process->id).'#produk' }}" class="btn btn-sm btn-warning ms-2">Lengkapi</a></div>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <td>
                                    <div class="dropdown dropstart">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if($process->status != '2')
                                            <li>
                                                <button type="button" class="dropdown-item d-flex {{$process->status == 0 ? 'text-warning' : 'text-success'}} align-items-center gap-3"
                                                    data-bs-toggle="modal" data-bs-target="#processModal-{{$process->id}}"><i
                                                        class="fs-4 ti {{$process->status == 0 ? 'ti-loader-3' : 'ti-check'}}"></i>{{$process->status == 0 ? 'Proses Pembelian' : 'Selesaikan Pembelian'}}</button>
                                            </li>
                                            @endif
                                            <li>
                                                <button type="button" class="dropdown-item d-flex align-items-center gap-3 text-danger"
                                                    onclick="seePDF('pdf.po','{{$process->id}}')"><i
                                            ...
                                            <li>
                                                <button type="button"
                                                    ...
                                                    data-bs-target="#deleteModal-{{ $process->id }}"><i
                                    ...
                                    @if($process->status == '2')
                                    <!-- invoicing Modal -->
                                    <div class="modal fade" id="invoicingModal-{{$process->id}}" tabindex="-1"
                                        aria-labelledby="vertical-center-modal" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <div class="modal-header d-flex align-items-center">
                                                    <h4 class="modal-title" id="myLargeModalLabel" style="white-space: normal">
                                                        Buat Penagihan / Invoice {{$process->code}}
                                                    </h4>
                                                    <button type="button" class="btn-close mb-auto" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body pt-0">
                                                    <form action="{{ route('request-process.generate', $process->id) }}" method="POST">
                                                        @csrf
                                                        <p class="text-muted" style="white-space: normal">Pastikan Keadaan lapangan sudah sesuai, dan dapat dipertanggung jawabkan dengan baik untuk <strong>Buat Penagihan / Invoice dengan kode Pemrosesan Permintaan Client {{$process->code}} (sebagai Hutang)</strong>. Seluruh Invoice akan dibuat termasuk Permintaan (sebagai Piutang) dan Pengangkutan (sebagai Hutang)</p>
                                                        <div class="d-flex gap-1 align-items-center justify-content-end">
                                                            <button type="submit"
                                    ...
                                    <!-- Delete Modal -->
                                    <div id="deleteModal-{{ $process->id }}" class="modal fade" tabindex="-1"
                                            ...
                                            <div class="modal-content p-3 modal-filled bg-danger">
                                                <div class="modal-header modal-colored-header text-white">
                                                    <h4 class="modal-title text-white" id="danger-header-modalLabel">
                                                        Yakin ingin menghapus Pembelian {{ $process->code }} ?
                                                    </h4>
                                                    <button type="button" class="btn-close btn-close-white"
                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body" style="width: fit-content; white-space:normal">
                                                    <h5 class="mt-0 text-white">Pemrosesan Permintaan Client {{ $process->code }}
                                                        akan dihapus</h5>
                                                    <p class="text-white">Segala data yang berkaitan dengan Pemrosesan Permintaan Client
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{ route('request-process.destroy', $process->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('delete')
