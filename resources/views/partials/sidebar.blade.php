        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar>
            <ul id="sidebarnav">
                ...
                @if(auth()->user() && auth()->user()->getRoleNames()[0] != 'pelanggan')
                    ...
                    <li class="sidebar-item {{ Route::is('product_type.*') ? 'selected' : '' }}">
                        <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                            <span class="d-flex">
                                <i class="ti ti-tag"></i>
                            </span>
                            <span class="hide-menu">Tipe Produk</span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level">
                            <li class="sidebar-item">
                                <a href="{{ route('product_type.index') }}" class="sidebar-link">
                                    <div class="round-16 d-flex align-items-center justify-content-center">
                                        <i class="ti ti-circle"></i>
                                    </div>
                                    <span class="hide-menu">Semua Tipe Produk</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{ route('product_type.add') }}" class="sidebar-link">
                                    <div class="round-16 d-flex align-items-center justify-content-center">
                                        <i class="ti ti-circle"></i>
                                    </div>
                                    <span class="hide-menu">Tambah Tipe Produk</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-item {{ Route::is('bal.*') ? 'selected' : '' }}">
                        <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                            ...
                            <span class="hide-menu">Bal</span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level">
                            <li class="sidebar-item">
                                <a href="{{ route('bal.index') }}" class="sidebar-link">
                                    <div class="round-16 d-flex align-items-center justify-content-center">
                                        <i class="ti ti-circle"></i>
                                    </div>
                                    <span class="hide-menu">Semua Bal</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{ route('bal.add') }}" class="sidebar-link">
                                    <div class="round-16 d-flex align-items-center justify-content-center">
                                        <i class="ti ti-circle"></i>
                                    </div>
                                    <span class="hide-menu">Tambah Bal</span>
                                </a>
                            </li>
                        </ul>
                    </li>

                    <li class="sidebar-item {{ Route::is('payment.*') ? 'selected' : '' }}">
                        <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                            <span class="d-flex">
                        ...
                        <ul aria-expanded="false" class="collapse first-level">
                            <li class="sidebar-item">
                                <a href="{{ route('payment.index') }}" class="sidebar-link">
                                    ...
                                    <span class="hide-menu">Semua Payment</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{ route('payment.add') }}" class="sidebar-link">
                                    <div class="round-16 d-flex align-items-center justify-content-center">
                                        <i class="ti ti-circle"></i>
                                    </div>
                    ...
                    <li class="sidebar-item {{ Route::is('warehouse.*') ? 'selected' : '' }}">
                        <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                            <span class="d-flex">
                        ...
                        <ul aria-expanded="false" class="collapse first-level">
                            <li class="sidebar-item">
                                <a href="{{ route('warehouse.index') }}" class="sidebar-link">
                                    ...
                                    <span class="hide-menu">Semua Gudang</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{ route('warehouse.add') }}" class="sidebar-link">
                                    <div class="round-16 d-flex align-items-center justify-content-center">
                                        <i class="ti ti-circle"></i>
                                    </div>
                    ...
                    <li class="sidebar-item {{ Route::is('store.*') ? 'selected' : '' }}">
                        <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                            <span class="d-flex">
                        ...
                        <ul aria-expanded="false" class="collapse first-level">
                            ...
                            <li class="sidebar-item">
                                <a href="{{ route('store.add') }}" class="sidebar-link">
                                    <div class="round-16 d-flex align-items-center justify-content-center">
                                        <i class="ti ti-circle"></i>
                                    </div>
                        ...
                        <ul aria-expanded="false" class="collapse first-level">
                            <li class="sidebar-item">
                                <a href="{{ route('partner.index') }}" class="sidebar-link">
                                    ...
                                    <span class="hide-menu">Semua Partner</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{ route('partner.add') }}" class="sidebar-link">
                                    <div class="round-16 d-flex align-items-center justify-content-center">
                                        <i class="ti ti-circle"></i>
                                    </div>
                                    <span class="hide-menu">Tambah Baru</span>
                        ...
                        <ul aria-expanded="false" class="collapse first-level">
                            <li class="sidebar-item">
                                <a href="{{ route('stock.distribution') }}" class="sidebar-link">
                                    ...
                                    <span class="hide-menu">Semua Distribusi</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                    ...
                    <li class="sidebar-item {{ Route::is('customer-order.*') && !Route::is('customer-order.invoice*') ? 'selected' : '' }}">
                        <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                            <span class="d-flex">
                                <i class="ti ti-heart-handshake"></i>
                            </span>
                            <span class="hide-menu">Penjualan Instan</span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level">
                            
                            <li class="sidebar-item">
                                <a href="{{ route('customer-order.index') }}" class="sidebar-link">
                                    <div class="round-16 d-flex align-items-center justify-content-center">
                                        <i class="ti ti-circle"></i>
                                    </div>
                                    <span class="hide-menu">Semua Penjualan Instan</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{ route('customer-order.partner.index') }}" class="sidebar-link">
                                    <div class="round-16 d-flex align-items-center justify-content-center">
                                        <i class="ti ti-circle"></i>
                                    </div>
                                    <span class="hide-menu">Semua Hutang ke Partner</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{ route('customer-order.add') }}" class="sidebar-link">
                                    <div class="round-16 d-flex align-items-center justify-content-center">
                                        <i class="ti ti-circle"></i>
                                    </div>
                                    <span class="hide-menu">Tambah Baru</span>
                    ...
                    <li class="nav-small-cap mt-0">
                        <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
                        <span class="hide-menu">Delivery Management</span>
                    </li>
