                    ...
                    <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-semibold">Height / Tinggi (cm)</label>
                                    <div class="input-group">
                                        <span class="input-group-text px-6" id="basic-addon1"><i
                                                class="ti ti-arrow-up fs-6"></i></span>
                                        <input type="number" name="height" value="{{old('height')}}" class="form-control ps-2" placeholder="Height Product">
                                    </div>
                                    @error('height')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-4">
                                    <label class="form-label fw-semibold">Width / Lebar (cm)</label>
                                    <div class="input-group">
                                        <span class="input-group-text px-6" id="basic-addon1"><i
                                                class="ti ti-arrow-right fs-6"></i></span>
                                        <input type="number" name="width" value="{{old('width')}}" class="form-control ps-2" placeholder="Width Product">
                                    </div>
                                    @error('width')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                        ...
                        <div class="p-3 rounded-3 bg-primary-subtle mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text px-6" id="basic-addon1"><i
                                            class="ti ti-text-caption fs-6"></i></span>
                                    <input type="text" name="price_per_unit" value="{{formatRupiah(old('price_per_unit'))}}" class="form-control bg-white ps-2 input-rupiah" placeholder="Rp. ">
                                </div>
