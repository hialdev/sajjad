    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Tambah Tipe Produk</h4>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="px-4 py-3 border-bottom">
                    <h5 class="card-title fw-semibold mb-0">Tambah Tipe Produk</h5>
                </div>
                    ...
                    <form action="{{ route('product_type.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" value="{{old('name')}}" class="form-control ps-2" placeholder="Name Type Product.. eg. Karpet Iran">
                            </div>
                            @error('name')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                            ...
                            <div class="input-group mb-2">
                                ...
                                <div style="flex-grow:1">
                                    <select name="type" id="type" class="select2-normal form-select">
                                        ...
                                        @php
                                            $types = config('al.types');    
                                        @endphp
                                        @foreach ($types as $code => $type)
                                            <option value="{{$code}}" {{ $code == old('code') ? 'selected' : '' }}>
                                                {{ ucfirst($type) }}
                                            </option>
                                        @endforeach
                                    </select>
